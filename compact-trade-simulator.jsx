// Browser-compatible version - no imports needed, uses global React
const { useState, useEffect } = React;

function CompactTradeSimulator() {
  // Get Lucide icons from global scope
  const { TrendingUp, DollarSign, BarChart3, ArrowRight, Users, FileText, Calculator, Settings } = lucide;
